                                  ...
                                  <form class="form-inline" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                  <label for="to">Mode of Payment:</label>
                                            ...
                                            <div class="form-group">
                                              <button type="button" class="btn btn-primary" id="expcard">OK</button>
                                            </div>
...
$('#Section1').hide();
$('.bodyheader').html('Expense Report-PaymentMode Wise');
